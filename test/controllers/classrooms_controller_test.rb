...
class ClassroomsControllerTest < ActionController::TestCase
  ...
  test "should create classroom" do
    assert_difference('Classroom.count') do
      post :create, classroom: { classroom_description: @classroom.classroom_description, classroom_status_id: @classroom.classroom_status_id }
    end
  ...
  test "should update classroom" do
    patch :update, id: @classroom, classroom: { classroom_description: @classroom.classroom_description, classroom_status_id: @classroom.classroom_status_id }
    assert_redirected_to classroom_path(assigns(:classroom))
  end
