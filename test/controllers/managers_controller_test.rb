...
class ManagersControllerTest < ActionController::TestCase
  ...
  test "should create manager" do
    assert_difference('Manager.count') do
      post :create, manager: { address: @manager.address, email: @manager.email, m_first_name: @manager.m_first_name, m_last_name: @manager.m_last_name, phone: @manager.phone }
    end
  ...
  test "should update manager" do
    patch :update, id: @manager, manager: { address: @manager.address, email: @manager.email, m_first_name: @manager.m_first_name, m_last_name: @manager.m_last_name, phone: @manager.phone }
    assert_redirected_to manager_path(assigns(:manager))
  end
