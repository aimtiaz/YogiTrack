...
class EquipmentCheckoutsControllerTest < ActionController::TestCase
  ...
  test "should create equipment_checkout" do
    assert_difference('EquipmentCheckout.count') do
      post :create, equipment_checkout: { checkin_date: @equipment_checkout.checkin_date, checkout_date: @equipment_checkout.checkout_date, customer_id: @equipment_checkout.customer_id, equipment_id: @equipment_checkout.equipment_id, equipment_status_id: @equipment_checkout.equipment_status_id }
    end
  ...
  test "should update equipment_checkout" do
    patch :update, id: @equipment_checkout, equipment_checkout: { checkin_date: @equipment_checkout.checkin_date, checkout_date: @equipment_checkout.checkout_date, customer_id: @equipment_checkout.customer_id, equipment_id: @equipment_checkout.equipment_id, equipment_status_id: @equipment_checkout.equipment_status_id }
    assert_redirected_to equipment_checkout_path(assigns(:equipment_checkout))
  end
