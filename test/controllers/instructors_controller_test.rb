...
class InstructorsControllerTest < ActionController::TestCase
  ...
  test "should create instructor" do
    assert_difference('Instructor.count') do
      post :create, instructor: { address: @instructor.address, email: @instructor.email, i_first_name: @instructor.i_first_name, i_last_name: @instructor.i_last_name, manager_id: @instructor.manager_id, phone: @instructor.phone }
    end
  ...
  test "should update instructor" do
    patch :update, id: @instructor, instructor: { address: @instructor.address, email: @instructor.email, i_first_name: @instructor.i_first_name, i_last_name: @instructor.i_last_name, manager_id: @instructor.manager_id, phone: @instructor.phone }
    assert_redirected_to instructor_path(assigns(:instructor))
  end
