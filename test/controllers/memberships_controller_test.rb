...
class MembershipsControllerTest < ActionController::TestCase
  ...
  test "should create membership" do
    assert_difference('Membership.count') do
      post :create, membership: { cost: @membership.cost, membership_description: @membership.membership_description }
    end
  ...
  test "should update membership" do
    patch :update, id: @membership, membership: { cost: @membership.cost, membership_description: @membership.membership_description }
    assert_redirected_to membership_path(assigns(:membership))
  end
